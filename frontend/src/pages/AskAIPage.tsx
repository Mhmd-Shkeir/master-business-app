    ...
    <div className="animate-fade-in mx-auto flex min-h-[70vh] max-w-3xl flex-col px-8 py-6">
      ...
      <form onSubmit={handleSubmit} className="flex gap-2">
        <input
          ...
          className="min-w-0 flex-1 rounded-md border border-neutral-300 px-3 py-2 text-sm shadow-sm outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/10"
        />
        <button
          type="submit"
